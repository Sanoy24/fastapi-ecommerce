...
Revision ID: b9f8c01d8585
Revises: c53356e23c4e
Create Date: 2025-11-01 11:40:58.644180
...
revision: str = 'b9f8c01d8585'
down_revision: Union[str, Sequence[str], None] = 'c53356e23c4e'
...
def upgrade() -> None:
    ...
    sa.Column('role', sa.Enum('customer', 'admin', name='user_roles'), nullable=True),
    ...
    sa.Column('payment_status', sa.Enum('pending', 'success', 'failed', name='payment_status'), nullable=True),
